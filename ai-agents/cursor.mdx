...
<Step title="Create a .cursorrules file">
  ...
  - Video (premium): varg.videoModel("seedance_2") — ByteDance, per-second billing, duration 4-15s
  - Video (budget): varg.videoModel("piapi:seedance-2-mini") — ByteDance cheap tier via exact model_key, duration 4-15s
