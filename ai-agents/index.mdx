...
| Seedance 2 (cheap tiers) | `varg.videoModel("piapi:seedance-2-mini")` | 4-15s (int) | Budget ByteDance via exact model_key | 74 (5s@720p) |
...
| Video 5s | seedance_2 via `piapi:seedance-2-mini` | 74 |
| Video 5s | seedance_2 via `piapi:seedance-2` | 105 |
