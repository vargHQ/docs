...
<Note>
Seedance 2 bills per second and spans 9 routes; estimates are exact when you pass a numeric `duration` (`"auto"` reserves the worst case). Pin an exact key like `piapi:seedance-2` (5s@720p = 105 credits) or `piapi:seedance-2-mini` (5s@480p = 37 credits, cheapest) for the lower tiers. See [Seedance 2](/models/video/seedance-2) for the full route table.
</Note>
