...
| Video (5s) | kling-v3 | 100 | $1.00 |
| Video (5s) | seedance-2-preview | 150 | $1.50 |
...
No installation needed. Submit TSX code to the [Cloud Render API](/render-api) via curl:
  ...
  <Render width={1080} height={1920}>
    <Clip duration={5}>
      <Video
        ...
        model={varg.videoModel("kling-v2")}
      />
    </Clip>
  </Render>
)
